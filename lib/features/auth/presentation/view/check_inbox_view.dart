...
import '../manager/cubit/email_verification_cubit.dart';
            ...
            children: [
              ...
              isVerified
                  ? ErrorInfo(
                      ...
                      description:
                          "An email is sent to your inbox to verify your account.",
                  ...
                  : ErrorInfo(
                      ...
                      description:
                          "Please wait until we confirm your email, you will be redirected automatically.",
                      // button: you can pass your custom button,
                      btnText: "Refresh",
                      press: () {
                        context
